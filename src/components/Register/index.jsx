...
class TextFields extends Component {
  ...
  render() {
    ...
    return (
      ...
      <CustomStepper handleNext={() => this.handleNextStep()} handleBack={() => this.handleBackStep()} />
      <form
      ...
      onChange={this.handleChange('countryResidence')}
      inputProps={{
      ...
      onChange={this.handleChange('countryCitizenship')}
      inputProps={{
